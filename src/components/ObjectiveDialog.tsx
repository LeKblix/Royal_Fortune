...
const ObjectiveDialog = ({ open, onClose, onUpgrade }: ObjectiveDialogProps) => {
  const [upgrades] = React.useState([
    { type: 'multiply', label: 'Multiplicateur ×3 pour les paires' },
    { type: 'brelan', label: 'Multiplicateur ×3 pour les brelans' },
    { type: 'straight', label: 'Multiplicateur ×2 pour les quintes' },
    { type: 'flush', label: 'Multiplicateur ×2 pour les couleurs' },
    { type: 'full', label: 'Multiplicateur ×3 pour les full' },
    { type: 'carre', label: 'Multiplicateur ×3 pour les carrés' },
    { type: 'straightFlush', label: 'Multiplicateur ×4 pour les quintes flush' },
    { type: 'doublePaire', label: 'Multiplicateur ×2 pour les doubles paires' },
  ]);
